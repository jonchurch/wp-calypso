...
class SocialLoginForm extends Component {
	...
	handleGoogleResponse = ( response ) => {
		...
		this.props.loginSocialUser( 'google', response.Zi.id_token ).then( () => {
			this.props.recordTracksEvent( 'calypso_login_social_form_login_success', {
			...
			if ( error === 'unknown_user' ) {
				...
				wpcom.undocumented().usersSocialNew( 'google', response.Zi.id_token, 'login', ( wpcomError, wpcomResponse ) => {
					...
					if ( wpcomError ) {
						this.props.recordTracksEvent( 'calypso_login_social_form_login_fail', {
							social_account_type: 'google',
						...
						this.props.recordTracksEvent( 'calypso_login_social_form_signup_success', {
							social_account_type: 'google',
						} );
